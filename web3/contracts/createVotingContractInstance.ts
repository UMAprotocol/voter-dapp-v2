...
const temporaryVotingV2Abi = [
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_spamDeletionProposalBond", type: "uint256" },
      { internalType: "uint64", name: "_unstakeCoolDown", type: "uint64" },
      { internalType: "uint64", name: "_phaseLength", type: "uint64" },
      { internalType: "uint64", name: "_minRollToNextRoundLength", type: "uint64" },
      { internalType: "uint256", name: "_gat", type: "uint256" },
      { internalType: "uint64", name: "_startingRequestIndex", type: "uint64" },
      { internalType: "address", name: "_votingToken", type: "address" },
      { internalType: "address", name: "_finder", type: "address" },
      { internalType: "address", name: "_slashingLibrary", type: "address" },
      { internalType: "address", name: "_previousVotingContract", type: "address" },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "bytes", name: "encryptedVote", type: "bytes" },
    ],
    name: "EncryptedVote",
    type: "event",
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: "bool", name: "executed", type: "bool" },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint256", name: "tokensSent", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "voterActiveStake", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "voterPendingStake", type: "uint256" },
    ],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "uint256", name: "newGat", type: "uint256" }],
    name: "GatChanged",
    type: "event",
  },
  {
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "uint256", name: "newEmissionRate", type: "uint256" }],
    name: "SetNewEmissionRate",
    type: "event",
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "uint256", name: "newUnstakeCoolDown", type: "uint256" }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint256[2][]", name: "spamRequestIndices", type: "uint256[2][]" },
    ],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "uint256", name: "newBond", type: "uint256" }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint256", name: "voterActiveStake", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "voterPendingStake", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "voterPendingUnstake", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "cumulativeActiveStake", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "cumulativePendingStake", type: "uint256" },
    ],
    name: "Staked",
    type: "event",
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint256", name: "lastUpdateTime", type: "uint256" },
    ],
    name: "UpdatedReward",
    type: "event",
  },
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "address", name: "voter", type: "address" },
      { indexed: false, internalType: "int256", name: "slashedTokens", type: "int256" },
      { indexed: false, internalType: "uint256", name: "postActiveStake", type: "uint256" },
    ],
    name: "VoterSlashed",
    type: "event",
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint256", name: "tokensWithdrawn", type: "uint256" },
    ],
  ...
  },
  {
    ...
    name: "_getPriceFromPreviousVotingContract",
    outputs: [
  ...
  { inputs: [], name: "executeUnstake", outputs: [], stateMutability: "nonpayable", type: "function" },
  {
    inputs: [],
    name: "gat",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "uint256", name: "time", type: "uint256" },
          { internalType: "bytes", name: "ancillaryData", type: "bytes" },
          { internalType: "uint64", name: "priceRequestIndex", type: "uint64" },
        ],
  ...
  },
  {
    ...
    outputs: [
      {
        components: [
          { internalType: "enum VotingV2.RequestStatus", name: "status", type: "uint8" },
          { internalType: "uint256", name: "lastVotingRound", type: "uint256" },
        ],
  ...
  {
    inputs: [{ internalType: "uint256", name: "spamDeletionRequestId", type: "uint256" }],
    name: "getSpamDeletionRequest",
    outputs: [
      {
        components: [
          { internalType: "uint256[2][]", name: "spamRequestIndices", type: "uint256[2][]" },
  ...
  },
  {
    inputs: [],
    name: "getVotePhase",
    outputs: [{ internalType: "enum VotingV2Interface.Phase", name: "", type: "uint8" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  {
    inputs: [{ internalType: "address", name: "voterAddress", type: "address" }],
    name: "getVoterStake",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  ...
  },
  {
    ...
    outputs: [{ internalType: "contract OracleAncillaryInterface", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint64", name: "pendingRequestIndex", type: "uint64" },
      { internalType: "uint64", name: "priceRequestIndex", type: "uint64" },
  ...
  },
  {
    ...
    outputs: [
      {
        components: [
          { internalType: "uint256", name: "wrongVoteSlashPerToken", type: "uint256" },
          { internalType: "uint256", name: "noVoteSlashPerToken", type: "uint256" },
          { internalType: "uint256", name: "totalSlashed", type: "uint256" },
          { internalType: "uint256", name: "totalCorrectVotes", type: "uint256" },
        ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "cumulativeActiveStakeAtRound", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [{ internalType: "uint256", name: "newGat", type: "uint256" }],
    name: "setGat",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [{ internalType: "address", name: "newVotingAddress", type: "address" }],
    name: "setMigrated",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [{ internalType: "uint256", name: "NewRewardsExpirationTimeout", type: "uint256" }],
  ...
  {
    inputs: [{ internalType: "address", name: "_newSlashingLibrary", type: "address" }],
  ...
  {
    inputs: [{ internalType: "uint256", name: "_spamDeletionProposalBond", type: "uint256" }],
  ...
  {
    inputs: [{ internalType: "uint64", name: "newUnstakeCoolDown", type: "uint64" }],
  ...
  {
    inputs: [{ internalType: "uint256[2][]", name: "spamRequestIndices", type: "uint256[2][]" }],
  ...
  },
  {
    ...
    outputs: [{ internalType: "contract SlashingLibraryInterface", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "minRollToNextRoundLength", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "pendingUnstake", type: "uint256" },
      { internalType: "uint256", name: "pendingStake", type: "uint256" },
      { internalType: "uint256", name: "rewardsPaidPerToken", type: "uint256" },
      ...
      { internalType: "uint64", name: "unstakeRequestTime", type: "uint64" },
