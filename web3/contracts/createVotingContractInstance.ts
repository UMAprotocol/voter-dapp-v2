...
const temporaryVotingV2Abi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint256", name: "voterStake", type: "uint256" },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: "uint256", name: "roundId", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "priceRequestIndex", type: "uint256" },
      { indexed: true, internalType: "bytes32", name: "identifier", type: "bytes32" },
      { indexed: false, internalType: "uint256", name: "time", type: "uint256" },
      { indexed: false, internalType: "bytes", name: "ancillaryData", type: "bytes" },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint256", name: "cumulativeStake", type: "uint256" },
    ],
    name: "Staked",
    type: "event",
  },
