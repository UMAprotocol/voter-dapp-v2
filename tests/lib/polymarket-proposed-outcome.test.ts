...
describe("originally proposed Polymarket outcome", () => {
  it.each([
    ["0", { label: "No", value: "0" }],
    ["1000000000000000000", { label: "Yes", value: "1" }],
    ["500000000000000000", { label: "unknown/50-50", value: "0.5" }],
    [earlyRequestMagicNumberWei, { label: "Early request" }],
    [undefined, undefined],
    ["", undefined],
    ["invalid", undefined],
